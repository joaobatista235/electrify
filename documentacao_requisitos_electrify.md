...
| O sistema deverá permitir que novos usuários se cadastrem fornecendo informações básicas como nome, e-mail e senha. Após o cadastro bem-sucedido, o usuário terá acesso completo às funcionalidades do aplicativo com perfil inicial configurado. |
...
|------|
| **DESCRIÇÃO DETALHADA DO REQUISITO FUNCIONAL** |
| O sistema deverá apresentar dicas educativas categorizadas para economia de energia. Deve permitir que o usuário marque dicas como lidas e filtre por categorias de interesse, integrando com sistema de recompensas. |
| **REQUISITOS NÃO FUNCIONAIS RELACIONADOS** |
| **DESCRIÇÃO DETALHADA DA REGRA/RESTRIÇÃO** | **TIPO** | **CLASSIFICAÇÃO** |
| RNFR-7.1 As dicas devem ser organizadas por categorias para facilitar busca. | Padrão | Obrigatório |
| RNFR-7.2 O sistema deve controlar quais dicas foram lidas para evitar recompensas duplicadas. | Padrão | Obrigatório |
| RNFR-7.3 O progresso de leitura deve ser salvo no perfil do usuário. | Padrão | Obrigatório |
...
| DESCRIÇÃO DETALHADA DA REGRA/RESTRIÇÃO | TIPO | CLASSIFICAÇÃO |
|----------------------------------------|------|---------------|
| RNFR-T.1 O aplicativo deve ser compatível com dispositivos móveis Android e iOS. | Tecnológico | Obrigatório |
